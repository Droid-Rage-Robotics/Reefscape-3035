...
//Autonomous
public class AutoAli extends Command {
	...
	public AutoAli(SwerveDrive drive, Vision vision) {
		this.drive = drive;
		this.vision = vision;
	...
	double limelight_range_proportional() {
		double targetingForwardSpeed = xController.calculate(vision.gettY(DroidRageConstants.leftLimelight), -1.5);
	...
	double limelight_aim_proportional() {
		double targetingAngularVelocity = rotController.calculate(vision.gettX(DroidRageConstants.leftLimelight), -11.5);
